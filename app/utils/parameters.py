...
class Parameter(enum.StrEnum):
    ...
    PIVOT_SPEED_REFERENCE = "PIVOT_SPEED_REFERENCE"        # degrees / milli-frame
    ...
    FOLD_SPEED_REFERENCE = "FOLD_SPEED_REFERENCE"          # degrees / milli-frame
    ...
    TILT_SPEED_REFERENCE = "TILT_SPEED_REFERENCE"          # degrees / milli-frame
    ...
    ROTATE_SPEED_REFERENCE = "ROTATE_SPEED_REFERENCE"      # degrees / milli-frame
    ...
    GATE_SPEED_REFERENCE = "GATE_SPEED_REFERENCE"          # degrees / milli-frame
